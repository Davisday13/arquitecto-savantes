...
import { UserCog, Edit, ShieldCheck, Plus } from 'lucide-react';
...
export default function UsuariosView() {
  ...
  const puedeCrear = profile?.rol === 'ROOT' || profile?.rol === 'ADMIN';
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-1">
          {puedeCrear && <Button onClick={() => setShowCreate(true)}><Plus className="h-4 w-4" /> Nuevo usuario</Button>}
