...
export const PERMISOS_POR_ROL = {
  ...
  ADMIN: { dashboard:7, proyectos:7, cotizaciones:7, pagos:7, gastos:7, inventario:7, estado_cuenta:7, clientes:7, usuarios:7, permisos:7, auditoria:7, reportes:7, notificaciones:7, configuracion:7, correos:7 },
  ARQUITECTO: { dashboard:7, proyectos:7, cotizaciones:7, pagos:5, gastos:5, inventario:5, estado_cuenta:5, clientes:5, usuarios:0, permisos:0, auditoria:0, reportes:3, notificaciones:3, configuracion:0, correos:1 },
  ASISTENTE: { dashboard:5, proyectos:5, cotizaciones:5, pagos:3, gastos:3, inventario:3, estado_cuenta:3, clientes:3, usuarios:0, permisos:0, auditoria:0, reportes:0, notificaciones:1, configuracion:0, correos:1 },
  CLIENTE: { dashboard:1, proyectos:1, cotizaciones:0, pagos:1, gastos:0, inventario:0, estado_cuenta:1, clientes:1, usuarios:0, permisos:0, auditoria:0, reportes:0, notificaciones:1, configuracion:0, correos:0 },
};
